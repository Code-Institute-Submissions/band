...
//uses jquery to change the opacity on the footer when being scrolled
...
//bookings form users javascript for dates and collecting data for the booking form. 
    ...
    angular.element(document).ready(function() {
        $(function() {
            $("#datepicker").datepicker({
                ...
                minDate: 0 //minDate: 0 added to prevent users from selecting a date in the past
            })
...
//mail list signs up users to recieve email blasts
